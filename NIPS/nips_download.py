...
- Rename PDFs using code-one-like safe filename + required pattern:
  '([C]-2025-NeurIPS)<title_or_id>.pdf'
"""
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--csv", type=str, default="./files/NeurIPS 2024 Events.csv",
    ...
    p.add_argument("--year", type=int, default=2024, help="Year for filename prefix, e.g., 2025")
    p.add_argument("--conf", type=str, default="NeurIPS", help="Venue tag for filename prefix, e.g., NeurIPS")
    return p
