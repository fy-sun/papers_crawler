...
def build_argparser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--csv", type=str, default="./files/ICLR 2025 Events.csv",
    ...
    p.add_argument("--conf", type=str, default="ICLR", help="Venue tag for filename prefix, e.g., ICLR")
    return p
